...
var tx:Number;
		...
		function MyGame(){
			...
			token = root.loaderInfo.parameters.fb_access_token|| "EAACEdEose0cBABnt6mwxIDzMG1yO0mUGZB5Luohotj5scTFPbzyrnFnRyoMk8IZBDwYFT6rMgBusCTZC4bO0NHoDLGkl5HHTAEcMAJKVNERBwzZBwLotrdOCgo9VVACHQZAiljRJBDOhQhHdtOhiwxJEkizKL9DZCmdFpQMpAQ2yiuF245PycfdGIdvZBTWFh4ZD"
...
public function hasItem(param1: String) {
 ...
 trace(user1337s[0].name);
	  what.name1.text=user1337s[0].name;
	   ...
	   what.nenene.text="You have friends";
